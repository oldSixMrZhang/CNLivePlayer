...
// 切换直播视频
// a:activityId c:channelId
#define PlayerLiveVideoId(a, c) [NSString stringWithFormat:@"%@:%@", a, c]

typedef void (^SuccessBlock) (void);
typedef void (^FailureBlock) (NSError *error);
typedef void (^AnchorStatus)(CNLiveAnchorStatus status);
...
/*
 ...
 @param result 重新获取主播直播状态

 @since v0.0.1
 */
- (void)retryToGetAnchorStatusResult:(AnchorStatus)result;
